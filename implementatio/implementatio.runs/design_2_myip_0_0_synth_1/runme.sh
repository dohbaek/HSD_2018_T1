...
HD_PWD='/csehome/dohbaek/HSD_2018_T1/implementatio/implementatio.runs/design_2_myip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_myip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_myip_0_0.tcl
